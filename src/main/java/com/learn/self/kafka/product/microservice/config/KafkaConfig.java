...
public class KafkaConfig {
    ...
    public NewTopic createTopic() {
        return TopicBuilder.name("product-created-events-topic")
                ...
                .configs(Map.of("min.insync.replicas", "1")) // additional property: minimum number of in-sync/synchronized replicas (including leader) that must acknowledge the message
                .build();
    }
